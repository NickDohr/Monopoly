...
public class Spaces
	{
		...
		public static void fillboard()
			{			
				...
				board.add(new Property("Oriental Avenue", 6, 100, 50, 6, 30, 90, 270, 400, 550, 50, "Brown"));
				board.add(new BoardSpace("Chance Card", 7));
				board.add(new Property("Vermont Avenue", 8, 100, 50, 6, 30, 90, 270, 400, 550, 50, "Brown"));
				board.add(new Property("Connecticut Avenue", 9, 120, 50, 8, 40, 100, 300, 450, 600, 60, "Brown"));
				board.add(new BoardSpace("Jail", 10));
				board.add(new Property("St. Charles Place", 11, 140, 100, 10, 50, 150, 450, 625, 750, 70, "Brown"));
				board.add(new Utility("Electric Company", 12, 150, 0));
				board.add(new Property("States Avenue", 13, 140, 100, 10, 50, 150, 450, 625, 750, 70, "Brown"));
				board.add(new Property("Virginia Avenue", 14, 160, 100, 12, 60, 180, 500, 700, 900, 80, "Brown"));
				board.add(new Railroad("Pennsylvania Railroad", 15, 25, 50, 100, 200, 100, 200));
				board.add(new Property("St. James Place", 16, 180, 100, 14, 70, 200, 550, 750, 950, 90, "Brown"));
				board.add(new BoardSpace("Community Chest", 17));
				board.add(new Property("Tennessee Avenue", 18, 180, 100, 14, 70, 200, 550, 750, 950, 90, "Brown"));
				board.add(new Property("New York Avenue", 19, 200, 100, 16, 80, 220, 600, 800, 1000, 100, "Brown"));
				board.add(new BoardSpace("Free Parking", 20));
				board.add(new Property("Kentucky Avenue", 21, 220, 150, 18, 90, 250, 700, 875, 1050, 110, "Brown"));
				board.add(new BoardSpace("Chance Card", 22));
				board.add(new Property("Indiana Avenue", 23, 220, 150, 18, 90, 250, 700, 875, 1050, 110, "Brown"));
				board.add(new Property("Illinois Avenue", 24, 240, 150, 20, 100, 300, 750, 925, 1100, 120, "Brown"));
				board.add(new Railroad("B. & O. Railroad", 25, 25, 50, 100, 200, 100, 200));
				board.add(new Property("Atlantic Avenue", 26, 260, 150, 22, 110, 330, 800, 975, 1150, 130, "Brown"));
				board.add(new Property("Ventnor Avenue", 27, 260, 150, 22, 110, 330, 800, 975, 1150, 130, "Brown"));
				board.add(new Utility("Water Works", 28, 150, 0));
				board.add(new Property("Marvin Gardens", 29, 280, 150, 24, 120, 360, 850, 1025, 1200, 140, "Brown"));
				board.add(new BoardSpace("Go To Jail", 30));
				board.add(new Property("Pacific Avenue", 31, 300, 200, 26, 130, 390, 900, 1100, 1275, 150, "Brown"));
				board.add(new Property("North Carolina Avenue", 32, 300, 200, 26, 130, 390, 900, 1100, 1275, 150, "Brown"));
				board.add(new BoardSpace("Community Chest", 33));
				board.add(new Property("Pennsylvania Avenue", 34, 320, 200, 28, 150, 450, 1000, 1200, 1400, 160, "Brown"));
				board.add(new Railroad("Short Line", 35, 25, 50, 100, 200, 100, 200));
				board.add(new BoardSpace("Chance Card", 36));
				board.add(new Property("Park Place", 37, 350, 200, 35, 175, 500, 1100, 1300, 1500, 175, "Brown"));
				board.add(new BoardSpace("Luxury Tax", 38));
				board.add(new Property("Boardwalk", 39, 400, 200, 50, 200, 600, 1400, 1700, 2000, 200, "Brown"));
			}
